...
<head>
	...
	<meta name="facebook-domain-verification" content="hhcova5rqwx3kv5fqn3l75buqrht97" />
		...
		<div class="container header__container">
			...
			?>
				<a class="logo header__logo">
					<img src="<?php echo get_template_directory_uri(); ?>/img/logo.svg" alt="Education Design - Дизайн Освіти">
				</a>
			<?php
				}
				else {
			...
			<div class="header__right">
				<nav class="nav menu-nav">
					...
					<!--button class="search-link btn-reset"><!?php
