									...
									<div class="container education__form">
										...
										<div class="education__form--right">
											<div class="contacts-form-wrapper contacts-form-wrapper__padding">
												<h2 class="contacts__title blog-title">
												 <?php
                        		    								$url = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                        
                                    									if (strpos($url, '/ru/') !== false) {
                                        									echo 'Записаться на консультацию';
                                    									}
                                    									else {
                                        									echo "Записатися на консультацію";
                                    									}
                        									?>
												 ...
												 <?php
                        		    								$url = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                                    									...
                                    									if (strpos($url, '/ru/') !== false) {
                                        									echo do_shortcode('[contact-form-7 id="52d42e5" title="Контактная форма 1" html_id="contact-form-page-contact"]');
                                    									}
                                    									else {
                                        									echo do_shortcode('[contact-form-7 id="89376ae" title="Контактная форма УКР" html_id="contact-form-page-contact"]');
                                    									}
                        									?>
